...
public class BirdController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        audioSource = GetComponent<AudioSource>(); // Obtenemos el AudioSource del pájaro
    }
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (deathSound != null) // Verificamos si se ha asignado un sonido de muerte
        {
            audioSource.PlayOneShot(deathSound); // Reproducimos el sonido de muerte
        }
